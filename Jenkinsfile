    ...
    stages {
        ...
        stage("Deploy to Docker Swarm") {
            steps {
                ...
                // // Log in to Docker Hub if your images are hosted on Docker Hub
                    // docker login -u your-docker-hub-user -p your-docker-hub-password
                    // Deploy to Docker Swarm
                bat "docker stack deploy --compose-file docker-compose.yml myapp"
            }
        }
